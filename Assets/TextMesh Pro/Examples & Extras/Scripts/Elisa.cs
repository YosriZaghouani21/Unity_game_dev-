...
public class Elisa : MonoBehaviour
{
    ...
    internal void StartConversation()
    {
        ...
        {
        "Step into the realm of ancient legends, dear traveler. I am Elissa, whispered of as Dido, a Phoenician princess whose story shimmers with the brilliance of magic and determination.",
        "Amidst tyranny's grasp, I sailed to North Africa. There, with mystical negotiation, I claimed a territory for a city, Carthage, shaped from a bull's hide enchanted with the promise of prosperity.",
        "Carthage bloomed into a mystical tapestry of trade and culture, woven by the threads of my defiance and unyielding spirit.",
        "Listen closely and feel the whispers of history – a tale of enchantment, where a princess forged her destiny on the sun-kissed shores of the Mediterranean."
        };
