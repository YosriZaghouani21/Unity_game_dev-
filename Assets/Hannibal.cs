...
public class Hannibal : MonoBehaviour
{
    ...
    internal void StartConversation()
    {
        ...
        {
    "As you navigates the tapestry of history, you find yourself on the cusp of the final level—an era shrouded in the mystique of Carthage. " ,
    "Hannibal's enigmatic brilliance and the echoes of his audacious journey beckon. " ,
    "In the shadows of this ancient empire, where war elephants once trod, the last chapter of the temporal odyssey awaits discovery. " ,
    "Brace yourself, for the whispers of Hannibal guide the traveler through the cryptic finale of this timeless quest."
        };
